...
PHP_CLI_SERVICE=baget-ru-php-cli
NODE_CLI_SERVICE=baget-ru-node-cli
MARIA_DB_CONTAINER=baget-ru-mariadb
SPHINX_CONTAINER=baget-ru-sphinx
...
docker-build: \
	docker-build-baget-ru-nginx \
	docker-build-baget-ru-php-fpm \
	docker-build-baget-ru-php-cli

docker-build-baget-ru-nginx:
	@docker build -t baget-ru-nginx:${IMAGE_TAG} ./docker/${ENV}/nginx

docker-build-baget-ru-php-fpm:
	@docker build -t baget-ru-php-fpm:${IMAGE_TAG} ./docker/${ENV}/php-fpm

docker-build-baget-ru-php-cli:
	@docker build -t baget-ru-php-cli:${IMAGE_TAG} ./docker/${ENV}/php-cli
